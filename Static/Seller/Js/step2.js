...
$(".letter ul li a").click(function(){
	...
	getBrand({first_letter:first_letter, force:1});
});
//根据关键字检索
$(".search a").click(function(){
	var keyword = $("#search_brand_keyword").val();
	getBrand({keyword:keyword, force:1});
});
//选择品牌
...
function removeImg(goods_id,img_name,e){
	$.get("/Admin/Goods/removeImg",{goods_id:goods_id,img_name:img_name, store_id:$("#store_id").val()},function(res){
		if(res.status == 1){
