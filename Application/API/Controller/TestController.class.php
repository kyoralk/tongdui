...
class TestController extends Controller{
	public function send(){
		...
		unset($params['zhburl']);
		unset($params['zhbtype']);
		$res = $this->http($url, $params,$type,true);
		echo $res;
	}
	/**
	 ...
	 */
	private function http($url, $params, $method = 'POST', $header = array("content-type: application/x-www-form-urlencoded;charset=UTF-8"), $multi = false){
		$opts = array(
				CURLOPT_TIMEOUT        => 30,
